...
export type HOMEPAGE_QUERYResult = {
  ...
  pageBuilder: Array<{
    ...
    actions: Array<{
      ...
      link: {
        slug: Array<null> | null | string;
        externalUrl: string | null;
        phone: string | null;
        isBookingWidget: boolean | null;
      };
    }> | null;
  } | {
    _type: "separator";
